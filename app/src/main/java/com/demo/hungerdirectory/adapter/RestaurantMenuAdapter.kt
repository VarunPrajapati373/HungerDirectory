...
import com.demo.hungerdirectory.activity.CartActivity
import com.demo.hungerdirectory.model.RestaurantMenu

class RestaurantMenuAdapter(val context: Context, val restaurantId:String, val restaurantName:String, val proceedToCartPassed: RelativeLayout, val buttonProceedToCart: Button, val restaurantMenu:ArrayList<RestaurantMenu>):
    ...
    class ViewHolderRestaurantMenu(view:View):RecyclerView.ViewHolder(view){
        ...
        val textViewItemName:TextView=view.findViewById(R.id.textItemName)
