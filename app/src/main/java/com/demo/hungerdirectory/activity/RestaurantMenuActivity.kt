...
import com.demo.hungerdirectory.adapter.RestaurantMenuAdapter
...
class RestaurantMenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activity_restaurant_menu_Progressdialog=findViewById(R.id.activity_restaurant_menu_Progrssdialog)
    ...
    fun fetchData(){
        ...
        if (ConnectionManager().checkConnectivity(this)) {
            ...
            try {
                ...
                //val restaurantId:String=sharedPreferencess.getString("restaurantId","0")
