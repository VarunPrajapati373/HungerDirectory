...
import com.demo.hungerdirectory.fragment.DashboardFragment
import com.demo.hungerdirectory.fragment.FaqsFragment
import com.demo.hungerdirectory.fragment.FavouriteRestaurantFragment
import com.demo.hungerdirectory.fragment.ProfileFragment
...
class Dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //set user details
        textViewcurrentUser.text=sharedPreferencess.getString("name","Varun Prajapati")
            ...
            when(it.itemId){//it holds the id of the currently selected item
                ...
                R.id.myProfile ->{
                    ...
                    supportFragmentManager.beginTransaction()
                        ...
                        //so that the app foesnt close on clicking the backbtn, it store the fragments in backstack and goes to previous fragment
                ...
                R.id.favouriteRestaurant ->{
                    ...
                    supportFragmentManager.beginTransaction()
                        ...
                        //so that the app doesnt close on clicking the backbtn, it store the fragments in backstack and goies to previous fragment
                        .commit()//apply changes
                ...
                R.id.faqs ->{
                    ...
                    supportFragmentManager.beginTransaction()
                        ...
                        //so that the app was not close on clicking the backbtn, it store the fragments in backstack and goes to previous fragment
                        .commit()//apply changes
